...
const notesDB = [
  ...
  {
    id: 'n1VoUaA9203',
    createdAt: "Apr 1, '08 at 08:30",
    type: 'NoteTodos',
    isPinned: true,
    style: { background: `url('https://www.gstatic.com/keep/backgrounds/grocery_light_0609_rtl.svg')` },
    info: {
      title: 'Bootcamp goals',
      todos: [
        { txt: 'Get a perfect CR', doneAt: 'Aug 20, 1994', isDone: false },
        { txt: 'Wake up every morning', doneAt: 'Sep 9, 2011', isDone: false },
        { txt: 'Go to sleep before 01:00', doneAt: 'Apr 19, 2022', isDone: false },
        { txt: 'Learn to render states', doneAt: 'Jun 1, 2023', isDone: false },
      ],
      labels: [{ txt: 'work', color: '#CDEDF6' }],
    },
  },
  {
    id: 'n102',
  ...
  },
  {
    ...
    info: {
      ...
      todos: [],
      labels: [],
      url: 'https://audio.jukehost.co.uk/dZ9LOOKXyhnxNB31zpy4KKYuBeYCb2Dw',
      coords: {
        lat: 0,
        lng: 0,
      },
  ...
  },
  {
    ...
    isPinned: true,
    createdAt: "Sep 10, '23 at 00:43",
    style: { background: `url('https://www.gstatic.com/keep/backgrounds/recipe_light_0609_rtl.svg')` },
    info: {
      title: 'בוקר טוב קודינג',
      txt: '',
      todos: [],
      labels: [],
      url: 'https://audio.jukehost.co.uk/2X2WWO53erWzkVFMPEawURsvMHifLqOJ',
      coords: {
        lat: 0,
        lng: 0,
      },
  ...
  {
    id: 'n43519104',
    createdAt: "Mar 12, '2399 at 01:00",
    type: 'NoteVideo',
    isPinned: true,
    style: { background: `url('https://www.gstatic.com/keep/backgrounds/travel_light_0614_rtl.svg')` },
    info: {
  ...
  {
    id: 'bJsalLI3',
    createdAt: "Nov 20, '23 at 07:24",
    type: 'NoteImg',
    isPinned: false,
    info: { url: 'https://i.ibb.co/MhBQRQC/7ylidy.jpg', title: 'PLEASE RENDER' },
    style: { background: '#aeccdc' },
  },
]
