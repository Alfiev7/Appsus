...
export function EmailCompose({ show, onClose, addNewEmail, draftData }) {
  ...
  const [isFromNote, setIsFromNote] = useState(draftData && draftData.isFromNote ? true : false)
  ...
  return (
    <div className='compose-container'>
      ...
      <div className='compose-forms'>
        <input className='compose-to' type='text' placeholder='To:' value={to} onChange={e => setTo(e.target.value)} />
        <input
